      ...
      <main className={styles.mainContent}>
        <div className={styles.topBar}>
          ...
          <div className={styles.topBarRight}>
            ...
            <button className="btn-primary" onClick={() => router.push('/provider/services')} style={{ fontSize: "0.813rem", padding: "10px 20px" }}>
               Add Service
            </button>
          </div>
        </div>
          ...
          <div className={styles.gridTwoCols}>
            ...
            <div className={styles.contentCard}>
              <div className={styles.contentCardHeader}>
                ...
                <Link href="/provider/bookings" className="btn-secondary" style={{ padding: "8px 16px", fontSize: "0.75rem" }}>View All</Link>
              </div>
