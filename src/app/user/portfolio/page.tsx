                  ...
                  {portfolios.map(item => (
                    <div key={item.id} style={{ border: "1px solid var(--border-light)", borderRadius: "var(--radius-sm)", overflow: "hidden", position: "relative" }}>
                      {item.media_type === "video" ? (
                        <video src={getImageUrl(item.media_path)} controls style={{ width: "100%", height: "150px", objectFit: "cover", background: "black" }} />
                      ) : (
                        <img src={getImageUrl(item.media_path)} alt="Portfolio" style={{ width: "100%", height: "150px", objectFit: "cover" }} />
                      )}
